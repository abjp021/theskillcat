...
const MentorshipSection = () => {
  ...
  return (
    <section id="mentorship" className="py-8 sm:py-12 lg:py-16 bg-background relative overflow-hidden">
      {/* Decorative background elements - Hidden on mobile */}
      <div className="hidden sm:block absolute top-0 right-0 w-96 h-96 bg-foreground/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
      <div className="hidden sm:block absolute bottom-0 left-0 w-96 h-96 bg-foreground/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        {/* Parallel Layout: Content Left, Visual Right */}
        <div
          ref={headerRef}
          className={`grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start transition-all duration-700 ${
            headerVisible
        ...
        >
          ...
          <div className="lg:sticky lg:top-24">
            ...
            <p className="text-muted-foreground text-sm sm:text-base lg:text-lg mb-2 sm:mb-3">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="group p-3 sm:p-4 border border-border rounded-lg bg-background hover:border-foreground/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-sm sm:text-base mb-0.5 sm:mb-1">Personalized Guidance</h3>
              ...
              <div className="group p-3 sm:p-4 border border-border rounded-lg bg-background hover:border-foreground/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-sm sm:text-base mb-0.5 sm:mb-1">Career Clarity</h3>
                    <p className="text-muted-foreground text-xs sm:text-sm">
              ...
              <div className="group p-3 sm:p-4 border border-border rounded-lg bg-background hover:border-foreground/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div>
                    <h3 className="font-display font-semibold text-sm sm:text-base mb-0.5 sm:mb-1">A Safe Space</h3>
                    <p className="text-muted-foreground text-xs sm:text-sm">
            ...
            <div>
              <h3 className="font-display font-semibold text-xs sm:text-sm text-muted-foreground uppercase tracking-wider mb-2 sm:mb-3">
                Featured Mentors
              </h3>
              <div className="space-y-2 sm:space-y-3">
                {featuredMentors.map((mentor, index) => (
                  ...
                  >
                    <CardHeader className="p-3 sm:p-6 pb-3">
                      <div className="flex items-start gap-2.5 sm:gap-3">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-foreground/10 to-foreground/5 flex items-center justify-center font-display font-bold text-base sm:text-lg text-foreground group-hover:scale-105 transition-transform flex-shrink-0">
                          {mentor.name
                            .split(" ")
                            .map((n) => n[0])
                            .join("")}
                        ...
                        <div className="flex-1 min-w-0">
                          <CardTitle className="text-sm sm:text-base mb-0.5 sm:mb-1">{mentor.name}</CardTitle>
                          ...
                          <div className="flex flex-wrap gap-1 sm:gap-1.5">
                            {mentor.expertise.slice(0, 2).map((skill, skillIndex) => (
                              <span
                                key={skillIndex}
                                className="inline-block bg-muted px-1.5 py-0.5 sm:px-2 sm:py-0.5 text-[10px] sm:text-xs font-medium text-foreground/70 rounded-full"
                              >
                                {skill}
                              </span>
                            ))}
