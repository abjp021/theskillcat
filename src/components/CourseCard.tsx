...
const CourseCard = ({
  ...
  return (
    <Link
      to={`/course/${id}`}
      className={`group block border border-border p-6 lg:p-8 bg-background transition-all duration-300 hover:shadow-lg hover:border-foreground/50 ${
    ...
    >
      ...
      {/* Course Title */}
      <h3 className="font-display font-bold text-xl lg:text-2xl mb-3 tracking-tight group-hover:text-foreground/80 transition-colors">
        {title}
      </h3>
