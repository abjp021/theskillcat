...
const FreeResources = () => {
  ...
  return (
    <section id="resources" className="py-12 lg:py-16 bg-background">
        ...
        >
          {resources.map((resource, index) => (
            <a
              key={resource.id}
              href="#"
              className={`group bg-muted/30 border border-border p-5 lg:p-6 transition-all duration-300 hover:border-foreground hover:shadow-lg ${
                gridVisible
                  ? "opacity-100 translate-y-0"
            ...
            >
              ...
              <h3 className="font-display font-semibold text-lg lg:text-xl mb-2 group-hover:text-foreground transition-colors">
                {resource.title}
              </h3>
